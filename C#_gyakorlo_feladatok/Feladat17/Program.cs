...
internal class Program
{
    ...
    static void Main()
    {
        ...
        //// 🔹 Új audióelemek hozzáadása
        manager.AddAudio(new CD("The Dark Side of the Moon", 42));
        manager.AddAudio(new Cassette("Greatest Hits", 2));

        //// 🔹 Fájlba mentés
        //FileHandling.SaveToFile(manager.Audios);

        //// 🔹 Betöltés fájlból
        //List<IAudio> loadedAudios = FileHandling.LoadFromFile();
        //foreach (var audio in loadedAudios)
        //{
        //    audio.Play();
        //}
