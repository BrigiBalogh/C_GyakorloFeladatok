...
//    Készíts a Program osztályba egy Write függvényt, amely megkap egy árut,
//    és kiírja annak nevét,/valamint nettó és bruttó árát.
{
    public static void Write(Goods g)
    {
        Console.WriteLine($"A(z) {g.Name} nettó ára: {g.NetPrice}, a bruttó ára: {g.GrossPrice():N0}");
    }
